...
LDFLAGS="-X github.com/terramate-io/tf/internal/command/e2etest.terraformBin=./terraform$GOEXE"
...
go test -o "$OUTDIR/e2etest$GOEXE" -c -ldflags "$LDFLAGS" github.com/terramate-io/tf/internal/command/e2etest
